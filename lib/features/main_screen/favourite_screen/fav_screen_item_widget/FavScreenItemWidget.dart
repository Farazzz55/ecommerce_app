...
class FavScreenItemWidget extends StatelessWidget {
  final GetCartProductsEntity dataEntity;
                  ...
                  child: IconButton(
                    onPressed: () {
                      CartScreenViewModel.get(context)
                          .deleteItemInCart(dataEntity.product?.id ?? '');
                    },
                    icon: Icon(
                      ...
                      children: [
                        IconButton(
                          onPressed: () {
                            ...
                            if (count > 1) count--;
                            CartScreenViewModel.get(context)
                                .updateItemInCart(dataEntity.product?.id ?? '', count);
                          },
                          icon: Icon(
