...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource{
  ...
  @override
  Future<Either<Failures, RegisterResponeDTO>> register(String name, String phone, String password, String rePassword, String email) async{
    try{
  ...
  Future<Either<Failures, LoginResponseDto>> login (String password, String email) async{
   try{
     var response =await apiManger.postData(EndPoint.login,body:{
       "email":email,
       "password":password
     });
